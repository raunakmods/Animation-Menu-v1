...
public class Menu extends Service {
    ...
    int BTN_COLOR = Color.parseColor("#4db6ac");
    ...
    int CategoryBG = Color.parseColor("#00000000");
    ...
    private void initFloating() {
        ...
        gdMenuBody.setCornerRadius(10); //Set corner
        gdMenuBody.setColor(Color.BLACK); //Set background color
        gdMenuBody.setStroke(6,(Color.GREEN));
        ...
        Raunak4 title = new Raunak4(this);
        ...
        colorAnimation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animator) {
                    heading.setTextColor((int) animator.getAnimatedValue());
                }
        ...
        closeBtn.setTextColor(Color.GREEN);
        ...
        for (int i = 0; i < listFT.length; i++) {
            ...
            switch (strSplit[0]) {
                case "Toggle":
                    ...
                    break;
                case "TG":
                    linearLayout.addView(Toggle(featNum, strSplit[1], switchedOn));
                    break;
                case "Tg":
                    linearLayout.addView(AddToggle(featNum, strSplit[1], switchedOn));
                    break;
                case "SeekBar":
                ...
                case "Text":
                    subFeat++;
                    linearLayout.addView(Text(strSplit[1]));
                    break;
                case "Rainbow":
                    subFeat++;
                    linearLayout.addView(Rainbow(strSplit[1]));
                    break;
                case "Category":
                    subFeat++;
    ...
    private View Toggle(final int featNum, final String featName, boolean swiOn) {
        final GradientDrawable rm = new GradientDrawable();
        rm.setCornerRadius(50);
        rm.setSize(dp(10),dp(1));
        rm.setAlpha(50);
        rm.setColor(Color.WHITE);      
        
        final  GradientDrawable raunak= new  GradientDrawable();
        raunak.setSize(50,50);
        raunak.setShape(1);
        raunak.setStroke(3,Color.WHITE);
        raunak.setColor(Color.BLACK);
        
        final GradientDrawable raunakm = new GradientDrawable();
        raunakm.setColor(Color.BLACK);
        raunakm.setSize(10,4);
        raunakm.setStroke(3,Color.WHITE);
        raunakm.setCornerRadius(100);
        
        final Switch switchh = new Switch(this);
        switchh.setText(featName);
        switchh.setTextColor(Color.WHITE);
        switchh.setTypeface(null, Typeface.BOLD_ITALIC);
        switchh.setPadding(10, 3, 3, 3);
        switchh.setTextSize(15.0f);
        switchh.setBackgroundColor(Color.TRANSPARENT);
        switchh.setThumbDrawable(raunak);
        switchh.setTrackDrawable(raunakm);
        switchh.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, dp(40)));
        switchh.setTypeface(switchh.getTypeface(), Typeface.NORMAL);
        switchh.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {

                    if(isChecked) {
                        raunakm.setColor(Color.GREEN);
                        raunak.setColor(Color.GREEN);

                    } else {
                        raunakm.setColor(Color.RED);
                        raunak.setColor(Color.RED);
                    }
                }
            });
        return switchh;
    }
    private View AddToggle(final int featNum, final String featName, boolean swiOn) {
        Switch switchR = new Switch(this);
        switchR.setBackgroundColor(Color.TRANSPARENT);
        switchR.setText(Html.fromHtml("<font face='roboto'>" + featName + "</font>"));
        switchR.setTextColor(Color.parseColor("BLACK"));
        GradientDrawable raunak= new  GradientDrawable();
        raunak.setSize(40,40);
        raunak.setShape(1);
        raunak.setStroke(3,Color.argb(255,15,169,255));
        raunak.setColor(Color.WHITE);
        final GradientDrawable rmods = new GradientDrawable();
        rmods.setColor(Color.RED);
        rmods.setSize(30,4);

        rmods.setColor(Color.parseColor("BLACK"));

        rmods.setCornerRadius(100);
        switchR.setThumbDrawable(raunak);
        switchR.setTrackDrawable(rmods);
    ...
    private View SB(final int featNum, final String featName, final int min, int max) {
            ...
            animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    ...
                    public void onAnimationUpdate(ValueAnimator animation) {
                       final int color = (int) animation.getAnimatedValue();
                        ...
                        gdMenuBody.setStroke(9, (color)); //Set border
                        gdMenuBody.setColor(Color.BLACK);
                        mExpanded.setBackground(gdMenuBody);
    ...
    private View Text(String text) {
        ...
        scale.setDuration(dur2);               
        scale.setRepeatCount(-1);               
        scale.setRepeatMode(Animation.REVERSE);
        textView.startAnimation(scale);
        return textView;
    }
    private View Rainbow(String text) {
        Raunak4 textView = new Raunak4(this);
        textView.setBackgroundColor(CategoryBG);
        textView.setText(Html.fromHtml(text));
        textView.setGravity(Gravity.CENTER);
        textView.setTextColor(TEXT_COLOR_2);
