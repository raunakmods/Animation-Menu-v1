...
void setTitleText(JNIEnv *env, jobject thiz, jobject obj) {
    setText(env, obj, OBFUSCATE("<b>RAUNAK</b>"));
...
void setHeadingText(JNIEnv *env, jobject thiz, jobject obj) {
    setText(env, obj, OBFUSCATE("<b><marquee><p style=\"font-size:30\">"
                                      "<p style=\"color:green;\">RAUNAK MODs YT</p> | "
                                      "THIS MENU IS MADE BY RAUNAK MODs BASED ON LGL MENU ITS FREE FOR ALL DONT SELL OR BUY </p>"
                                      "</marquee></b>"));
